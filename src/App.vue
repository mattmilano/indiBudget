...
<template>
  <div class="flex h-screen bg-gray-100 dark:bg-gray-900">
    ...
    <aside
      :class="[
        'fixed inset-y-0 left-0 z-50 flex flex-col bg-white dark:bg-gray-800 shadow-lg transition-all duration-300',
    ...
    >
      ...
      <div class="flex items-center justify-between h-16 px-4 border-b border-gray-200 dark:border-gray-700">
        <div class="flex items-center gap-3">
          ...
          <span v-if="sidebarOpen" class="text-xl font-bold text-gray-900 dark:text-white">indiBudget</span>
        </div>
        <button
      ...
      <!-- Footer -->
      <div v-if="sidebarOpen" class="p-4 border-t border-gray-200 dark:border-gray-700">
