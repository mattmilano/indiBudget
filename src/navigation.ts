 ...
 *
 * Extracted from `App.vue` so it can be checked against the router. A screen
 * that exists, routes correctly, and appears in no navigation is a screen
 * nobody can find — which is a way to ship a feature invisibly. The test in
 * `src/__tests__/navigation.test.ts` walks every route and fails on any that
 * this list cannot reach.
 *
 * **Add the entry here in the same commit as the screen.**
 */
...
export const navItems: NavItem[] = [
  ...
  { name: 'Sharing', path: '/sharing', icon: 'M8.684 13.342A3 3 0 108.684 10.658M15.316 10.658a3 3 0 100 2.684M6 12a3 3 0 11-6 0 3 3 0 016 0zm12-6a3 3 0 11-6 0 3 3 0 016 0zm0 12a3 3 0 11-6 0 3 3 0 016 0z' },
