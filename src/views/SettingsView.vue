      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        ...
        <div class="p-6">
          ...
          <div class="flex items-center gap-4 mb-6">
            ...
            <div>
              <h3 class="text-2xl font-bold text-gray-900 dark:text-white">indiBudget</h3>
              <p class="text-sm text-gray-500 dark:text-gray-400">Version 1.0.0</p>
            </div>
          </div>

          <p class="text-gray-600 dark:text-gray-300 mb-6">
            A powerful personal finance application with calendar-focused expense tracking,
            designed to help you take control of your money with intuitive tools and insights.
          </p>

          <!-- Features -->
          <div class="mb-6">
            <h4 class="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wide mb-3">Features</h4>
          ...
          <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
            <div class="flex flex-wrap gap-4 text-sm">
              <div>
                ...
                <span class="ml-1 text-gray-700 dark:text-gray-300">Matt Milano</span>
              </div>
              <div>
                <span class="text-gray-500 dark:text-gray-400">License:</span>
                <span class="ml-1 text-gray-700 dark:text-gray-300">MIT</span>
              </div>
            </div>
            <div class="mt-3 flex gap-3">
              <a
                href="https://github.com/mattmilano/indiBudget"
                target="_blank"
