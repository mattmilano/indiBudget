...
pub fn get_default_rules() -> Vec<CategoryRule> {
    ...
    for pattern in [
        ...
        rules.push(CategoryRule::with_priority(
            "cat_expense_credit_card".into(),
            pattern.into(),
            "description".into(),
            10,
        ));
    ...
    for pattern in [
        ...
        rules.push(CategoryRule::new(
            "cat_expense_transportation".into(),
            pattern.into(),
            "description".into(),
        ));
    }
    ...
    for pattern in [
        ...
        rules.push(CategoryRule::new(
            "cat_expense_entertainment".into(),
            pattern.into(),
            "description".into(),
        ));
    }
